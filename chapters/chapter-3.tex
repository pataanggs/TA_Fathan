...
\begin{enumerate}[noitemsep]
    ...
    \begin{itemize}[noitemsep]
        ...
        \item \textbf{No padding}: Audio pendek (2-20 detik) \textbf{tidak} di-\textit{pad} secara artifisial, karena Whisper dapat menangani audio dengan panjang variabel melalui mekanisme \textit{attention masking}
    \end{itemize}
...
\begin{enumerate}[noitemsep]
    ...
    \begin{itemize}[noitemsep]
        ...
        \item Model dilatih dari \textit{scratch} (dari \textit{pre-trained} Whisper Base) pada \textit{training set}
