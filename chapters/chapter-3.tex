...
\begin{enumerate}[noitemsep]
    ...
    \end{itemize}
    \item \textbf{Trainable Parameters}: $\sim$2\% dari total parameter ($\sim$5 juta parameter), drastis lebih sedikit dibanding \textit{Freeze Encoder}
...
\noindent
Ini menunjukkan bahwa LoRA hanya melatih $\sim$0.24\% dari total parameters Whisper Small, sangat efisien dibanding \textit{Freeze Encoder}.
