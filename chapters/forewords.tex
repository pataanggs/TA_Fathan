...
\begin{justifying}
    ...
    \begin{enumerate}
        ...
        \item Bapak Cahya Wirawan yang telah membuat dan memelihara dataset LibriVox Indonesia di HuggingFace, sehingga memberikan kontribusi berharga untuk penelitian ini.
        \item Semua pihak yang telah membantu dan mendukung penulis yang tidak dapat disebutkan satu per satu.
    \end{enumerate} 
