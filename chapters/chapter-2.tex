...
$S,D,I$ adalah jumlah \textit{substitution}, \textit{deletion}, \textit{insertion} terhadap $N$ kata referensi; subskrip $_c$ untuk level karakter. CER sering lebih stabil pada bahasa dengan variasi ejaan atau morfologi kaya (praktik 2020–2025).
